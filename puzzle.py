...
class GameGrid(Frame):
    ...
    #Initialise a grid:
    # Add background colour, size and padding to the grid.
    def init_grid(self):
        ...
        for i in range(c.GRID_LEN):
            ...
            for j in range(c.GRID_LEN):
                ...
                t = Label(
                    ...
                    width=5,
                    height=2)
                #Create a grid for numbers to be displayed
                t.grid()
                grid_row.append(t)
            self.grid_cells.append(grid_row)

    # Update the grid :
    # change the colour of a cell according to the number in it
